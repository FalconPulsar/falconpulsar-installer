...
# docker compose up -d --remove-orphans. The shell still shows a Workplace
# mode in that case — unlike Agents it is not gated on reachability — so it
# opens to an unavailable surface.
